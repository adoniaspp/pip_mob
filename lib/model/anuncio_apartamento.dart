...
class ListaApartamento {
  ...
  ListaApartamento.fromJson(Map<String, dynamic> json) {
    if (json['anuncio'] != null) {
      anuncio = new List<Apartamento>();
      json['anuncio'].forEach((v) {
        anuncio.add(new Apartamento.fromJson(v));
      });
    }
...
class Apartamento {
  ...
  Apartamento.fromJson(Map<String, dynamic> json) {
    ...
    area = json['area'];
    unidadesandar = json['unidadesandar'];
    andar = json['andar'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['area'] = this.area;
    data['unidadesandar'] = this.unidadesandar;
